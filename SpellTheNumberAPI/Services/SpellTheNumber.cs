...
namespace SpellTheNumberAPI.Services
{
    public class SpellTheNumber
    {        

        public string SpellIt(string numberToSpell)
        {
            if (!Int32.TryParse(numberToSpell, out int num))
                return "Input should be whole number";

            Regex trimmer = new Regex(@"\s\s+");
            return trimmer.Replace(SpellTheWord(numberToSpell), " ");
        }

        private string SpellTheWord(string wnumber)
        {
        ...
        private string Separator(string number)
        {
        ...
        private string Spell(string number)
        {
        ...
        private string SpellOnes(string number)
        {
            int num = Convert.ToInt32(number);
        ...
        private string SpellTens(string number)
        {
            int num = Convert.ToInt32(number);
            string spell = string.Empty;
            switch (num)
